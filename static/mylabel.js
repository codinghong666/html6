...
//         function typeTextsSequentially(texts, container, delay, fontSize, currentIndex = 0) {
...
//                 // 当前文本输出完成后，递归调用输出下一条
//                 typeTextsSequentially(texts, container, delay, fontSize, currentIndex + 1);
//             });
//         }

//         // 开始逐行输出文本，设置打字延迟为 70 毫秒
//         typeTextsSequentially(texts, container, delay, fontSize);
//     }
// }
